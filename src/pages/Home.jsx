                            ...
                            <div className="card h-100">
                                <div className="card-body d-flex flex-column align-items-center">
                                    ...
                                    <div className="mt-auto d-flex gap-2">
                                        <button onClick={() => handleDeleteClick(contact.id)} className="btn btn-outline-dark">
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <p>Estás seguro de querer borrar?</p>
                            </div>
                            <div className="modal-footer">
                                <button type="button" className="btn btn-outline-secondary" onClick={cancelDelete}>Cancelar</button>
                                <button type="button" className="btn btn-outline-danger" onClick={confirmDelete}>Borrar</button>
                            </div>
                        </div>
                    </div>
                </div>
